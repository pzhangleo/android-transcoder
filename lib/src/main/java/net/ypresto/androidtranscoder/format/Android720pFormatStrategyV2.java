 ...
 */
public class Android720pFormatStrategyV2 implements MediaFormatStrategy {
    ...
    public Android720pFormatStrategyV2() {
        this(DEFAULT_VIDEO_BITRATE);
    }

    public Android720pFormatStrategyV2(int videoBitrate) {
        this(videoBitrate, AUDIO_BITRATE_AS_IS, AUDIO_CHANNELS_AS_IS);
    }

    public Android720pFormatStrategyV2(int videoBitrate, int audioBitrate, int audioChannels) {
